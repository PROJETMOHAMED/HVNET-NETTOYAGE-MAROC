...
<head>
	...
	<meta name="Publisher " content="société de nettoyage" />
	...
	<meta name="description"
		content="Demandez un devis gratuit chez notre societe de nettoyage casablanca pour l'intervention le plus rapidement
		possible avec des materiels et des produit de qualite.">
	<title>Demandez un devis gratuit | HVNET NETTOYAGE</title>
	...
	<link rel="canonical" href="https://www.nettoyage-casablanca-maroc.net/devis-societe-nettoyage.php">
				...
				<div class="container my-3">
					<div class="row">
						<div class="col-md-12 align-self-center p-static order-2 text-center">
							<h1 class="font-weight-bold text-10">Demandez un Devis</h1>
						</div>
			...
			<div class="container py-5 mt-5">
				<div class="row pb-2 mb-4">
					<div class="col">
						...
						<p>Pour un nettoyage efficace, il est important d’être organisé et d’hiérarchiser les tâches.
							Cela permet d’éviter les pertes de temps inutiles. Notre <strong>société de nettoyage
								casablanca</strong> exerce
							dans ce domaine depuis de nombreuses années.</P>

						<P>Nous avons à notre actif plus de 15 années
							d’expérience grâce auxquelles nous ferons de votre logis un espace très propre. De plus,
							l’expérience acquise au cours de ces nombreuses années d’exercice nous permet de nettoyer et
							de réorganiser efficacement les services afin de maximiser l’espace.</p>
...
if (isset($_POST['sendEmailSubBtn'])) {
   ...
   if (
	   ...
	   if (mysqli_query($conn, $sqls)) {
		   ...
		   $subject = 'DEMANDE DE DEVIS HVNET NETTOYAGE';
...
?>
						...
						<br>
						<p>Nous travaillons pour le compte des <strong><em>particuliers</em></strong> et
							<strong><em>professionnelle</em></strong>, mais aussi des <em>industries</em>. Notre
							<strong>societe
								de nettoyage</strong> propose le nettoyage industriel. Généralement, après la fin des
							travaux sur un
							chantier, il reste des débris de matériaux qu’il faut débarrasser avant de rendre les
							ouvrages.</P>

						<P>Vous pouvez contacter notre <strong>société de nettoyage</strong> en <strong>fin de
								chantier</strong> pour nettoyer
							ces débris. <strong>HVNET NETTOYAGE</strong> propose ses services sur casablanca et partout
							au Maroc. Vous pouvez également
							nous contacter pour tout services de <em>nettoyage d'entretien</em> et de
							<em>desinfection</em> a casablanca.</P>
					</div>
				</div>
			</div>
			...
			<div class="container container-xl-custom pt-4 pb-3">
				<div class="row">
					...
					<div class="col-md-4 col-lg-3 mb-4 mb-lg-0">
						...
						<a href="a-propos-nous.html" class="btn btn-link font-weight-bold text-decoration-none ps-0">En
							Savoir Plus</a>
					</div>					
					<div class="col-md-4 col-lg-3 mb-4 mb-lg-0">
