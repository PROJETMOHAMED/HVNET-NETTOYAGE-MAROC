...
function buildNav(members) {
  ...
  nav.push(buildNavLink('logo', '<a class="nav-logo" href="https://www.nettoyage-casablanca-maroc.net" title="Bootstrap Colorpicker">' +
...
/**
 @param {TAFFY} taffyData See <taffydb.com/>.
 @param {object} opts
