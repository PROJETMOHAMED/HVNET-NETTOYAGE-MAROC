 ...
 * @version v3.2.0
 * @license MIT
 * @link itsjavi.com/bootstrap-colorpicker/
 * @link github.com/itsjavi/bootstrap-colorpicker.git
 */
...
/**
 * See en.m.wikipedia.org/wiki/Euclidean_distance#Squared_Euclidean_distance
 * */
...
Color.prototype = {
	...
	mix: function (mixinColor, weight) {
		...
		// github.com/sass/libsass/blob/0e6b4a2850092356aa3ece07c6b249f0221caced/functions.cpp#L209
...
cs.get.rgb = function (string) {
	...
	if (match = string.match(hex)) {
		...
		for (i = 0; i < 3; i++) {
			// jsperf.com/slice-vs-substr-vs-substring-methods-long-string/19
			var i2 = i * 2;
...
var swizzle = module.exports = function swizzle(args) {
	...
	for (var i = 0, len = args.length; i < len; i++) {
		...
		if (isArrayish(arg)) {
			// jsperf.com/javascript-array-concat-vs-push/98
...
function buildGraph() {
	var graph = {};
	// jsperf.com/object-keys-vs-for-in-with-closure/3
	var models = Object.keys(conversions);
