...
{
    const API_URL = 'graph.instagram.com/';

    const API_OAUTH_URL = 'api.instagram.com/oauth/authorize';

    const API_OAUTH_TOKEN_URL = 'api.instagram.com/oauth/access_token';
    
    const API_TOKEN_EXCHANGE_URL = 'graph.instagram.com/access_token';
    
    const API_TOKEN_REFRESH_URL = 'graph.instagram.com/refresh_access_token';
