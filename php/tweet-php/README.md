...
To interact with Twitter's API you will need an API KEY, which you can create at: dev.twitter.com/apps
...
Here is a full list of options, and their default values:
    ...
    'date_format'           => '%I:%M %p %b %d%O', // The defult date format e.g. 12:08 PM Jun 12th. See: php.net/manual/en/function.strftime.php
...
- Feed parsing uses Matt Harris' [tmhOAuth](github.com/themattharris/tmhOAuth)
- Hashtag/username parsing uses Mike Cochrane's [twitter-text-php](github.com/mikenz/twitter-text-php)
