...
repository:
    ...
    github.com/mzsanford/twitter-text-conformance
...
into `tests/spyc`:
    ...
    svn checkout spyc.googlecode.com/svn/trunk/ tests/spyc
...
The bulk of this library is from the heroic efforts of:
 ...
 - Matt Sanford (github.com/mzsanford): For the orignal Ruby and Java implementions.
 - Mike Cochrane (github.com/mikenz): For the initial PHP code.
 - Nick Pope (github.com/ngnpope): For the bulk of the maintenance work to date.
