 ...
 * @license    www.apache.org/licenses/LICENSE-2.0  Apache License v2.0
 * @package    Twitter
 */
 ...
 *
 * Originally written by {@link github.com/mikenz Mike Cochrane}, this
 * is based on code by {@link github.com/mzsanford Matt Sanford} and
 * heavily modified by {@link github.com/ngnpope Nick Pope}.
 *
 * @author     Mike Cochrane <mikec@mikenz.geek.nz>
 * @author     Nick Pope <nick@nickpope.me.uk>
 * @copyright  Copyright © 2010, Mike Cochrane, Nick Pope
...
class Twitter_Autolink extends Twitter_Regex {
   ...
   * @var  string
   */
  protected $url_base_user = 'twitter.com/';
   ...
   * @var  string
   */
  protected $url_base_list = 'twitter.com/';
   ...
   * @var  string
   */
  protected $url_base_hash = 'twitter.com/search?q=%23';
