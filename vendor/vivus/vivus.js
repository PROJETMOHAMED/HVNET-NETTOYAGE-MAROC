 ...
 * @version v0.4.6
 * @link github.com/maxwellito/vivus
 * @license MIT
 */
 ...
 * github.com/Waest/SVGPathConverter
 */
...
Pathformer.prototype.pathMaker = function (element, pathData) {
  var i, attr, pathTag = document.createElementNS('www.w3.org/2000/svg','path');
...
Vivus.prototype.mapping = function() {
  ...
  if (hasNonScale) {
    console.warn('Vivus: this SVG contains non-scaling-strokes. You should call instance.recalc() when the SVG is resized or you will encounter unwanted behaviour. See github.com/maxwellito/vivus#non-scaling for more info.');
  }
